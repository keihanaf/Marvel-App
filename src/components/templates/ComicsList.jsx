            ...
            {isComicLoading ? (
                ...
                <>
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                    >
                        <span className="relative z-10 font-semibold text-white">More Comics</span>
                    ...
                    >
                        {comic?.slice(10,15).map((comics) => (
                            <motion.div key={comics.id} variants={item}>
                                <Link to={`/comics/${comics.id}`} className="block">
                                    <motion.div
                                    ...
                                    >
                                        ...
                                        <div className="p-4">
                                            <h2 className="text-lg font-bold text-white truncate group-hover:text-red-400
                                                ...
                                                {removeHashAndAfter(comics.title)}
                                            </h2>
                                        </div>
                                    </motion.div>
                                </Link>
